! function(e) {
	...
	var i = n(3),
		a = n(10),
		s = (n(1), n(79), Object.prototype.hasOwnProperty),
		u = n(77),
		l = {
			key: !0,
			ref: !0,
	...
	"use strict";
	"undefined" === typeof Promise && (n(171).enable(), window.Promise = n(170)), n(185), Object.assign = n(3)
}, function(e, t, n) {
	"use strict";
	(function(t) {
		function n(e) {
	...
	var a = n(12),
		...
		p = function(e) {
			...
			return i(t, e), c(t, [{
				key: "handleRestore",
				value: function() {
					this.props.onHandleRestore && this.props.onHandleRestore(this.props.index)
				}
			}, {
				key: "render",
				value: function() {
					...
					}, this.props.content), s.a.createElement("span", {
						className: "dustbin-restore",
	...
	var a = n(12),
		...
		f = function(e) {
			...
			return i(t, e), p(t, [{
				key: "handleRestore",
				value: function(e) {
					this.props.onHandleRestore && this.props.onHandleRestore(e)
				}
			}, {
				key: "render",
				value: function() {
					...
					}, this.props.contents.map(function(t, n) {
						return s.a.createElement(u.a, {
							key: n,
							index: t.index,
							content: t.content,
							onHandleRestore: e.handleRestore.bind(e)
						})
					}))
				}
			}]), t
	...
	var a = n(12),
		...
		f = function(e) {
			...
			return i(t, e), p(t, [{
				...
				value: function() {
					var e = localStorage.getItem("user_contents");
					e && (e = JSON.parse(e), this.setState({
						contents: e
					}))
				}
			}, {
				...
				value: function() {
					var e = this.state.contents;
					e = JSON.stringify(e), localStorage.setItem("user_contents", e)
				}
			}, {
				key: "handleSubmit",
				value: function(e) {
					var t = this.state.contents;
					t.push(e), t.map(function(e, t) {
						return e.index = t
				...
				value: function(e) {
					var t = this,
						n = this.state.contents;
					n[e].flag = !0, console.log(n[e].content + "\u53d8\u6210\u4e86true"), this.setState({
						contents: n
					}, function() {
						t._saveLocalStorage()
					})
				...
				value: function(e) {
					var t = this,
						n = this.state.contents;
					n[e].flag = !1, console.log(n[e].content + "\u53d8false"), this.setState({
						contents: n
					}, function() {
						t._saveLocalStorage(), console.log(n)
					})
				}
			}, {
				key: "handleClearAll",
				value: function() {
					...
					try {
						for (var s, u = t[Symbol.iterator](); !(o = (s = u.next()).done); o = !0) {
							var l = s.value;
							l.flag && (console.log(l.flag), l.index = r, ++r, n.push(l))
						}
					} catch (e) {
						i = !0, a = e
					} finally {
					...
					console.log(n), this.setState({
						contents: n
					}, function() {
						e._saveLocalStorage(), console.log(t)
					})
				}
			}, {
				key: "render",
				value: function() {
					var e = this.state.contents,
						...
						i = void 0;
					try {
						for (var a, p = e[Symbol.iterator](); !(r = (a = p.next()).done); r = !0) {
							var f = a.value;
							!0 === f.flag ? t.push(f) : n.push(f)
						}
					} catch (e) {
						o = !0, i = e
					} finally {
	...
	var a = n(12),
		...
		p = function(e) {
			...
			return i(t, e), c(t, [{
				key: "HandleDelete",
				value: function() {
					this.props.onHandleDelete ? this.props.onHandleDelete(this.props.index) : console.log("\u6ca1\u6709onHandleDelete")
				}
			}, {
				key: "componentWillMount",
				value: function() {
			...
			return i(t, e), c(t, [{
				...
				value: function() {
					if ("" === this.state.content) {
						console.log("\u6ca1\u6709\u4efb\u52a1");
						var e = void 0;
						return clearTimeout(e), void this.setState({
							suspension: !0
						}, function() {
							var t = this;
				...
				value: function(e) {
					e.stopPropagation(), "Enter" === e.key && this.handleClick()
				}
			}, {
				key: "handleClearAll",
				value: function() {
				...
				value: function() {
					var e = this;
					return s.a.createElement("div", {
						className: "input-all-wrapper",
						onKeyDown: this.handleKeyDownEnter.bind(this)
					...
					}, "Add"), s.a.createElement("input", {
						className: "input-search",
						placeholder: "\u641c\u7d22\u8ba1\u5212"
					}), s.a.createElement("button", {
						className: "button-search"
					}, "Search"), s.a.createElement("button", {
						className: "button-clear",
						onClick: this.handleClearAll.bind(this)
					}, "Clear"), this.state.suspension ? s.a.createElement("div", {
	...
	var a = n(12),
		...
		f = function(e) {
			...
			return i(t, e), p(t, [{
				key: "handleDelete",
				value: function(e) {
					this.props.onHandleDelete ? this.props.onHandleDelete(e) : console.log("TodoList \u6ca1\u6709onHandleDelete")
				}
			}, {
				key: "render",
				value: function() {
					...
					return s.a.createElement("div", {
						...
						return s.a.createElement(u.a, {
							...
							key: n,
							index: t.index,
							onHandleDelete: e.handleDelete.bind(e)
						})
					}))
				}
			}]), t
	...
	var b = 1,
		_ = {
			...
			mountComponent: function(e, t, n, s) {
				...
				v || null != y && null != y.render ? i(d) ? this._compositeType = g.PureClass : this._compositeType = g.ImpureClass : (l = y, null === y || !1 === y || u.isValidElement(y) || a("105", d.displayName || d.name || "Component"), y = new r(d), this._compositeType = g.StatelessFunctional);
...
//# sourceMappingURL=main.608ee8cd.js.map